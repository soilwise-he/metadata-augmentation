...
class AsyncURLChecker:
    ...
    async def check_url(self, url: str, check_ogc_capabilities: bool = True, identifier: str = None, lname: str = None) -> Dict[str, Any]:
        """
    ...
    def _check_ogc_capabilities(self, url: str, identifier: str = None, lname: str = None) -> Optional[Dict[str, Any]]:
        """
